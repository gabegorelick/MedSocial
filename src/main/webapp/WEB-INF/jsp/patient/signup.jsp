      ...
      <div id="main" class="main" style="height:320px;">
           <div id="view_2" class="view" style="height:317px;">
              ...
              <div class="wrapper center" style="top:283px;margin-left:66px;">
                <input id="button_4" class="component button font_cursive" value="Submit" type="button" onClick="location.href='login.html';">
                </div>
              ...
              <div class="wrapper" style="top:285px;left:14px;">
                <input id="button_21" class="component button font_cursive" value="Cancel" type="button" onClick="location.href='login.html';">
                 </div>
            </div>
