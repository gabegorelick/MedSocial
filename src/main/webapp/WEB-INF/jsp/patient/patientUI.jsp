    ...
    <script>
      $(function() {
        ...
        $("#button_3").click(function() {
          setTimeout('toggleView("view_stack_1", "view_2")', 200);
        });

        $("#button_2").click(function() {
          setTimeout('toggleView("view_stack_1", "view_3")', 200);
        });

        $("#button_4").click(function() {
          setTimeout('toggleView("view_stack_1", "view_1")', 200);
        });
        ...
        $("#button_5").click(function() {
          setTimeout('toggleView("view_stack_1", "view_4")', 200);
        });

        $("#button_6").click(function() {
          setTimeout('toggleView("view_stack_1", "view_5")', 200);
        });

        $("#button_7").click(function() {
          setTimeout('toggleView("view_stack_1", "view_6")', 200);
        });

        $("#button_8").click(function() {
          setTimeout('toggleView("view_stack_1", "view_7")', 200);
        });
        ...
        $("#button_9").click(function() {
          setTimeout('toggleView("view_stack_1", "view_8")', 200);
        });
        ...
        $("#button_11").click(function() {
          setTimeout('toggleView("view_stack_1", "view_9")', 200);
        });
...
.fbProxyElement {
  ...
  <body class="body ui-widget ui-widget-content">
    ...
    <div id="content" class="content center" style="width:240px;min-width:240px;margin-top:20px;">
      <div id="main" class="main" style="height:320px;">
        <div class="wrapper" style="top:1px;left:1px;">
          <div id="view_stack_1" class="component view_stack" stack="true" style="width:237px;min-width:237px;">
            <div id="view_1" class="view" style="height:317px;">
              <div class="wrapper" style="top:208px;left:84px;">
                <input id="text_input_1" class="component text_input" size="20" style="width: 125px; min-width: 125px;" type="text">
              </div>
              <div class="wrapper" style="top:213px;left:20px;">
                <span id="label_1" class="component label font_cursive" style="width:51px;min-width:51px;">E-Mail</span>
              </div>
              <div class="wrapper" style="top:238px;left:19px;">
                <span id="label_2" class="component label font_cursive" style="width:60px;min-width:60px;">Password</span>
              </div>
              <div class="wrapper" style="top:235px;left:84px;">
                <input id="text_input_2" class="component text_input" size="20" style="width: 125px; min-width: 125px;" type="text">
              </div>
            ...
            <div id="view_2" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:81px;left:9px;">
                <span id="label_3" class="component label font_cursive">First Name</span>
              </div>
              <div class="wrapper" style="top:109px;left:10px;">
                <span id="label_4" class="component label font_cursive">Last Name</span>
              </div>
              <div class="wrapper" style="top:230px;left:12px;">
                <span id="label_5" class="component label font_cursive">Confirm Password</span>
              </div>
              <div class="wrapper" style="top:136px;left:9px;">
                <span id="label_6" class="component label font_cursive">E-Mail</span>
              </div>
              <div class="wrapper" style="top:183px;left:11px;">
                <span id="label_7" class="component label font_cursive">Password</span>
              </div>
              <div class="wrapper" style="top:41px;left:7px;">
                <span id="label_8" class="component label font_cursive" style="font-size:150%;">Patient Sign Up</span>
              </div>
              <div class="wrapper" style="top:87px;left:92px;">
                <span id="label_9" class="component label" style="width:130px;min-width:130px;"></span>
              </div>
              ...
              <div class="wrapper" style="top:110px;left:82px;">
                <input id="text_input_10" class="component text_input" size="20" style="width: 140px; min-width: 140px;" type="text">
              </div>
              <div class="wrapper" style="top:205px;left:11px;">
                <input id="password_1" class="component password" value="" size="20" type="password">
              </div>
              <div class="wrapper" style="top:251px;left:13px;">
                <input id="password_2" class="component password" value="" size="20" type="password">
              </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[remove
 button]<br>Description<br>_____________________________</span>
              </div>
              <div class="wrapper" style="top:227px;left:11px;">
                <span id="label_32" class="component label" style="width:215px;min-width:215px;border-width:1px;border-style:dashed;color:#cc0000;font-size:70%;">Doctor invite here... scrollable<br>__________________<br>Name<br>Email
 
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[accept
 button]<br>Description &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
              </div>
            </div>
            <div id="view_6" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:203px;left:9px;">
                <textarea id="textarea_1" class="component textarea font_cursive" rows="3" cols="20" value="Add a Note..." style="width: 201px; min-width: 201px;">Add a Note...</textarea>
              </div>
              <div class="wrapper center" style="top:288px;margin-left:-86px;">
                <input id="button_10" class="component button font_cursive" value="Save" type="button">
              </div>
            ...
            <div id="view_7" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:150px;left:12px;">
                <span id="label_15" class="component label font_cursive">Start Date</span>
              </div>
              <div class="wrapper" style="top:91px;left:9px;">
                <span id="label_16" class="component label font_cursive">Description</span>
              </div>
              <div class="wrapper" style="top:178px;left:12px;">
                <span id="label_18" class="component label font_cursive">End Date</span>
              </div>
              <div class="wrapper" style="top:65px;left:7px;">
                <input id="text_input_12" class="component text_input" size="20" style="width: 152px; min-width: 152px;" type="text">
              </div>
              <div class="wrapper" style="top:108px;left:10px;">
            ...
            <div id="view_8" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:108px;left:61px;">
                <input id="text_input_15" class="component text_input" size="20" type="text">
              </div>
              <div class="wrapper" style="top:165px;left:12px;">
                <textarea id="textarea_3" class="component textarea" rows="3" cols="20" style="width: 200px; min-width: 200px; height: 52px;"></textarea>
              </div>
              <div class="wrapper" style="top:80px;left:9px;">
                <span id="label_21" class="component label font_cursive">Name</span>
              </div>
              <div class="wrapper" style="top:109px;left:11px;">
                <span id="label_22" class="component label font_cursive">E-Mail</span>
              </div>
              <div class="wrapper" style="top:139px;left:11px;">
                <span id="label_23" class="component label font_cursive">Description</span>
              </div>
              <div class="wrapper" style="top:41px;left:7px;">
                <span id="label_24" class="component label font_cursive" style="font-size:150%;">Add a Doctor</span>
              </div>
            </div>
            <div id="view_9" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:148px;left:14px;">
                <div id="div_2" class="component div" style="width:200px;min-width:200px;height:134px;">
                  <div class="wrapper" style="top:62px;left:-1px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_9" name="checkbox_9" type="checkbox"><span class="input_label">Wednesday</span></label>
                  </div>
                  <div class="wrapper" style="top:40px;left:0px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_10" name="checkbox_10" type="checkbox"><span class="input_label">Tuesday</span></label>
                  </div>
                  <div class="wrapper" style="top:-1px;left:-1px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_11" name="checkbox_11" type="checkbox"><span class="input_label">Sunday</span></label>
                  </div>
                  <div class="wrapper" style="top:18px;left:0px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_12" name="checkbox_12" type="checkbox"><span class="input_label">Monday</span></label>
                  </div>
                  <div class="wrapper" style="top:97px;left:0px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_13" name="checkbox_13" type="checkbox"><span class="input_label">Friday</span></label>
                  </div>
                  <div class="wrapper" style="top:80px;left:0px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_14" name="checkbox_14" type="checkbox"><span class="input_label">Thursday</span></label>
                  </div>
                  <div class="wrapper" style="top:115px;left:1px;">
                    <label class="component checkbox font_cursive nowrap"><input id="checkbox_15" name="checkbox_15" type="checkbox"><span class="input_label">Saturday</span></label>
                  </div>
                </div>
              </div>
              <div class="wrapper" style="top:131px;left:15px;">
                <span id="label_26" class="component label font_cursive">Days</span>
              </div>
              <div class="wrapper" style="top:41px;left:7px;">
                <span id="label_27" class="component label font_cursive" style="font-size:150%;">Add Alert</span>
              </div>
              <div class="wrapper" style="top:102px;left:54px;">
                <input id="text_input_16" class="component text_input" size="20" style="width: 74px; min-width: 74px;" type="text">
              </div>
              <div class="wrapper" style="top:101px;left:145px;">
                <select id="dropdown_2" class="component dropdown font_cursive">
                  <option selected="selected" value="1">AM</option>
