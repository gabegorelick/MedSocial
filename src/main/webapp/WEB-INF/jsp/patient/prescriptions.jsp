      ...
      <div id="main" class="main" style="height:320px;">
	      ...
	      <div class="wrapper" style="top:10px;left:150px;">
              ...
              <div class="wrapper" style="top:286px;left:20px;">
                <input id="button_8" class="component button font_cursive" value="Add a Prescription" type="button" onClick="location.href='prescriptionsadd.html';">
                       </div>
              <div class="wrapper center" style="top:286px;margin-left:80px;">
                <input id="button_15" class="component button font_cursive" value="Done" type="button" onClick="location.href='main.html';">
                    </div>
