      ...
      <div id="main" class="main" style="height:320px;">
           <div id="view_9" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:288px;left:154px;">
                <input id="button_19" class="component button font_cursive" value="Submit" type="button" onClick="location.href='prescriptionsadd.html';">
                    </div>
              <div class="wrapper" style="top:290px;left:16px;">
                <input id="button_20" class="component button font_cursive" value="Cancel" type="button" onClick="location.href='prescriptionsadd.html';">
                  </div>
