      ...
      <div id="main" class="main" style="height:320px;">
	      ...
	      <div class="wrapper" style="top:10px;left:150px;">
              ...
              <div class="wrapper" style="top:257px;left:14px;">
                <input id="button_11" class="component button font_cursive" value="Add an Alert" type="button" onClick="location.href='alertadd.html';">
                   </div>
              ...
              <div class="wrapper" style="top:286px;left:128px;">
                <input id="button_12" class="component button font_cursive" value="Save" type="button" onClick="location.href='prescriptions.html';">
                 </div>
              <div class="wrapper" style="top:287px;left:61px;">
                <input id="button_13" class="component button font_cursive" value="Cancel" type="button" onClick="location.href='prescriptions.html';">
               </div>
