      ...
      <div id="main" class="main" style="height:320px;">
           <div id="view_3" class="view" style="height:317px;">
              ...
              <div class="wrapper" style="top:266px;left:109px;">
                <input id="button_6" class="component button font_cursive" value="Manage Doctors" style="width: 84px; min-width: 84px; height: 43px; font-size: 9px;" type="button" onClick="location.href='doctor.html';">
                   </div>
