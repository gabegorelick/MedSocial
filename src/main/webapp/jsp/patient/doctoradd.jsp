    ...
    <div id="content" class="content center" style="width:240px;min-width:240px;margin-top:20px;">
      <div id="main" class="main" style="height:320px;">
              ...
              <div class="wrapper" style="top:268px;left:152px;">
                <input id="button_17" class="component button font_cursive" value="Submit" type="button" onClick="location.href='doctor.html';">
                    </div>
              <div class="wrapper" style="top:269px;left:22px;">
                <input id="button_18" class="component button font_cursive" value="Cancel" type="button" onClick="location.href='doctor.html';">
                </div>
